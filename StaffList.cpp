#include "stdafx.h"  //________________________________________ StaffList.cpp
#include "StaffList.h"
...
BOOL WINAPI GetExtensionVersion(HSE_VERSION_INFO* pVer)
{
	...
	strcpy_s(pVer->lpszExtensionDesc, HSE_MAX_EXT_DLL_NAME_LEN, "StaffList ISAPI Extension");
...
void SelectWindow(const wchar_t* windowID, Web::HttpConnector& h)
{
	...
	else if(wcscmp(windowID, L"StaffSelect") == 0) {StaffSelect page; page.Run(h);}
}
